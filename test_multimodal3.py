import os
# Hide TensorFlow INFO messages to see our own prints clearly
...
def run_multimodal_monitor():
    ...
    try:
        ...
        print(f"   > Visual Model loaded successfully.")
    except Exception as e:
    ...
    print("--- Step 4: Initializing MediaPipe... ---")
    ...
    print("--- Step 6: Initializing Audio Stream... (Possible Stick Point) ---")
    try:
        p = pyaudio.PyAudio()
        # List devices to confirm mic exists
        ...
        print(f"   > ERROR: Audio Stream failed to start. {e}")
        return
            ...
            if frame_count % FRAME_SKIP == 0:
                ...
                if results.multi_face_landmarks:
                    for face_ID, face_landmarks in enumerate(results.multi_face_landmarks):
                        ...
                        # Safe cropping with bounds check
